     ...
     */
        ...
        try {
            ...
            const summary = {
                ...
                mismatchedRecordIds: matchAnalysis.mismatchedKeys || [],
...
async getSchemaAwareRecordCounts(tempTableId, sourceTableName, primaryKey, actualSourceTotal = null, isFiltered = false) {
    try {
        ...
        if (actualSourceTotal) {
            console.log(`📊 ACTUAL SOURCE TOTAL: ${actualTotalRecords.toLocaleString()} records`);
            console.log(`📦 SAMPLE SIZE VALIDATED: ${sampleSize.toLocaleString()} records`);
            console.log(`Source unique keys (in sample): ${jsonDetails.unique_primary_keys}, duplicates: ${jsonDetails.duplicate_records}`);
        } else {
